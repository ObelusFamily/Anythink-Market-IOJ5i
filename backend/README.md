...
Create a file called .env.local in the root backend directory and use .env.template to configure your environment.
Specifically make sure MONGODB_URI points to your local running Mongo DB server.
